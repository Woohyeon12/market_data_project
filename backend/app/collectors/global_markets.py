...
TRACKED_INSTRUMENTS = [
    ...
    ("GOOGL", "Alphabet", "US Stocks", "United States", "USD", 170.0, 0.0),
    ("AMZN", "Amazon", "US Stocks", "United States", "USD", 180.0, 0.0),
    ("META", "Meta Platforms", "US Stocks", "United States", "USD", 480.0, 0.0),
    ("TSLA", "Tesla", "US Stocks", "United States", "USD", 240.0, 0.0),
    ("BRK-B", "Berkshire Hathaway", "US Stocks", "United States", "USD", 410.0, 0.0),
    ("JPM", "JPMorgan Chase", "US Stocks", "United States", "USD", 210.0, 0.0),
    ("AVGO", "Broadcom", "US Stocks", "United States", "USD", 1700.0, 0.0),
    ...
    ("000270.KS", "Kia", "Korea Stocks", "South Korea", "KRW", 110000.0, 0.0),
    ("373220.KS", "LG Energy Solution", "Korea Stocks", "South Korea", "KRW", 400000.0, 0.0),
    ("207940.KS", "Samsung Biologics", "Korea Stocks", "South Korea", "KRW", 900000.0, 0.0),
    ("035420.KS", "NAVER", "Korea Stocks", "South Korea", "KRW", 200000.0, 0.0),
    ("035720.KS", "Kakao", "Korea Stocks", "South Korea", "KRW", 55000.0, 0.0),
    ("055550.KS", "Shinhan Financial Group", "Korea Stocks", "South Korea", "KRW", 50000.0, 0.0),
    ...
    ("9984.T", "SoftBank Group", "Japan Stocks", "Japan", "JPY", 8500.0, 0.0),
    ("6861.T", "Keyence", "Japan Stocks", "Japan", "JPY", 70000.0, 0.0),
    ("8035.T", "Tokyo Electron", "Japan Stocks", "Japan", "JPY", 35000.0, 0.0),
    ("9983.T", "Fast Retailing", "Japan Stocks", "Japan", "JPY", 42000.0, 0.0),
    ("9432.T", "Nippon Telegraph and Telephone", "Japan Stocks", "Japan", "JPY", 180.0, 0.0),
    ("8058.T", "Mitsubishi Corporation", "Japan Stocks", "Japan", "JPY", 3200.0, 0.0),
